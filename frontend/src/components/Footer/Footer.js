...
const Footer = () => {
  return (
    <CDBModalFooter className="shadow" style={{position:'fixed',bottom:'0'}}>
      <CDBBox
        display="flex"
        ...
        <CDBBox display="flex" alignItems="center">
          <a href="/" className="d-flex align-items-center p-0 text-dark">
            <img
              ...
              width="30px"
            />
            <span className="ml-4 h5 mb-0 font-weight-bold">NIT-OLX</span>
          </a>
          <small className="ml-2">&copy; NIT-OLX, 2022. All rights reserved.</small>
        </CDBBox>
        <CDBBox display="flex" alignItems="center">
            <span className="ml-1 h6 mb-0">Terms and Services</span>
          <small className="ml-2 h6 mb-0">Privacy Policy</small>
        </CDBBox>
        <CDBBox display="flex">
